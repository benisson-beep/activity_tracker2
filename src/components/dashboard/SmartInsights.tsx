  ...
  return (
    <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-[10px] font-medium tracking-wide px-2 py-0.5 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {insights.map(ins => (
          <div
            key={ins.id}
            className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700/60 hover:border-slate-300 dark:hover:border-slate-600 transition-colors"
          >
            <div className="flex items-center space-x-2 mb-1.5">
              <div className="p-1 rounded-lg bg-white dark:bg-slate-800 shadow-xs">
                {getIcon(ins.icon)}
              </div>
