...
export const SOCIAL_LINKS: SocialLinkItem[] = [
  {
    name: 'GitHub',
    url: 'https://github.com/benisson-beep/activity_tracker2',
  ...
  {
    name: 'X (Twitter)',
    url: 'https://twitter.com/chronicleapp',
  ...
  {
    name: 'Discord',
    url: 'https://discord.gg/chronicle',
  ...
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/company/chronicle-app',
  ...
  {
    name: 'YouTube',
    url: 'https://youtube.com/@chronicleapp',
      ...
      {SOCIAL_LINKS.map(item => {
        ...
        return (
          <a
            ...
            title={`Follow Chronicle on ${item.name}`}
            className={`${paddingClass} rounded-xl text-slate-400 dark:text-slate-400 ${item.hoverColor} transition-all duration-200 inline-flex items-center space-x-2 border border-transparent hover:border-slate-700/40`}
          >
